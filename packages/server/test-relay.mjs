...
const WebSocket = _require("/Users/johannsel/Informatik/swarmvault.gewitter.io/node_modules/.pnpm/ws@8.20.1/node_modules/ws");
...
await new Promise((resolve, reject) => {
  ...
  ws.on("message", (raw) => {
    ...
    if (msg.type === "auth_ack") {
      console.log("WS auth_ack received ✓");
      resolve();
    }
